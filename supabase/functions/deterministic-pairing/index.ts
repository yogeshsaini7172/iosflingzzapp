  ...
  try {
    ...
    for (const candidate of candidates) {
      ...
      results.push({
        ...
        candidate_personality_traits: candidate.personality_traits,
        candidate_body_type: candidate.body_type,
        candidate_skin_tone: candidate.skin_tone,
        candidate_values: candidate.values,
        candidate_mindset: candidate.mindset,
        candidate_relationship_goals: candidate.relationship_goals,
        candidate_height: candidate.height,
        candidate_lifestyle: candidate.lifestyle,
        candidate_love_language: candidate.love_language,
        candidate_field_of_study: candidate.field_of_study,
