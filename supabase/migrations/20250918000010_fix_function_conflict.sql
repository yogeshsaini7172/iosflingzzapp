...
DROP FUNCTION IF EXISTS get_user_chat_rooms(TEXT);
...
-- Create the get_user_chat_rooms function with new return type
...
-- Create a function to get messages for a chat room
