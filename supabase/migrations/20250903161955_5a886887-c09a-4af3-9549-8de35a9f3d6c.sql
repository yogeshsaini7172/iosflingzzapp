-- Insert test profiles for pairing verification (using random UUIDs)
INSERT INTO public.profiles (
  ...
  -- Female users
  (gen_random_uuid(), 'Alice', 'Johnson', 'alice.johnson@test.com', '2002-03-15', 'female', 'Stanford University', 
  ...
  (gen_random_uuid(), 'Emma', 'Wilson', 'emma.wilson@test.com', '2001-07-22', 'female', 'MIT', 
  ...
  (gen_random_uuid(), 'Sophia', 'Davis', 'sophia.davis@test.com', '2003-01-10', 'female', 'Harvard University', 
  ...
  (gen_random_uuid(), 'Olivia', 'Brown', 'olivia.brown@test.com', '2002-09-05', 'female', 'UCLA', 
  ...
  (gen_random_uuid(), 'Isabella', 'Garcia', 'isabella.garcia@test.com', '2001-12-18', 'female', 'University of Texas', 
  ...
  -- Male users  
  (gen_random_uuid(), 'James', 'Smith', 'james.smith@test.com', '2001-04-12', 'male', 'Stanford University', 
  ...
  (gen_random_uuid(), 'Michael', 'Johnson', 'michael.johnson@test.com', '2002-11-08', 'male', 'MIT', 
  ...
  (gen_random_uuid(), 'William', 'Davis', 'william.davis@test.com', '2003-06-25', 'male', 'Harvard University', 
  ...
  (gen_random_uuid(), 'Alexander', 'Wilson', 'alexander.wilson@test.com', '2001-08-30', 'male', 'UCLA', 
  ...
  (gen_random_uuid(), 'Benjamin', 'Miller', 'benjamin.miller@test.com', '2002-02-14', 'male', 'University of Texas', 
...
-- Get the user IDs we just created and create partner preferences
WITH new_users AS (
  SELECT user_id, first_name, gender FROM profiles 
  WHERE email IN ('alice.johnson@test.com', 'emma.wilson@test.com', 'sophia.davis@test.com', 'olivia.brown@test.com', 'isabella.garcia@test.com', 'james.smith@test.com', 'michael.johnson@test.com', 'william.davis@test.com', 'alexander.wilson@test.com', 'benjamin.miller@test.com')
)
...
SELECT 
  ...
  19 as age_range_min,
  28 as age_range_max,
  ARRAY['serious_relationship', 'companionship'] as preferred_relationship_goal
FROM new_users;

-- Initialize QCS scores for the new users
WITH new_users AS (
...
SELECT 
  user_id,
  80 + (random() * 20)::integer as profile_score,
  90 + (random() * 10)::integer as college_tier,
  75 + (random() * 25)::integer as personality_depth,
  100 as behavior_score,
  85 + (random() * 15)::integer as total_score
FROM new_users;