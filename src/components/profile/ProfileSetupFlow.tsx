...
const ProfileSetupFlow = ({ onComplete }: ProfileSetupFlowProps) => {
  ...
  console.log('Uploaded main image public URLs:', imageUrls);
      ...
      const completeProfile = {
        ...
        exercise_habits: profileData.exerciseHabits,
        ...
        children_plans: profileData.childrenPlans,
      ...
      const preferences = {
        ...
        preferred_exercise: profileData.preferredExercise || [],
        preferred_drinking: profileData.preferredDrinking || [],
        preferred_smoking: profileData.preferredSmoking || [],
        preferred_diet: profileData.preferredDiet || [],
        preferred_pets: profileData.preferredPets || [],
        preferred_children: profileData.preferredChildren || [],
      ...
      const { data: profileResult, error: profileError } = await supabase.functions.invoke('profile-completion', {
        body: {
          ...
          exerciseHabits: completeProfile.exercise_habits,
          drinkingHabits: completeProfile.drinking_habits,
          smokingHabits: completeProfile.smoking_habits,
          dietPreference: completeProfile.diet_preference,
          petPreference: completeProfile.pet_preference,
          childrenPlans: completeProfile.children_plans,
          ...
          preferences: {
            ...
            preferredExercise: preferences.preferred_exercise || [],
            preferredDrinking: preferences.preferred_drinking || [],
            preferredSmoking: preferences.preferred_smoking || [],
            preferredDiet: preferences.preferred_diet || [],
            preferredPets: preferences.preferred_pets || [],
            preferredChildren: preferences.preferred_children || [],
      ...
      const preferencesPayload = {
        ...
        preferred_exercise: Array.isArray(profileData.preferredExercise) ? profileData.preferredExercise : [],
        preferred_drinking: Array.isArray(profileData.preferredDrinking) ? profileData.preferredDrinking : [],
        preferred_smoking: Array.isArray(profileData.preferredSmoking) ? profileData.preferredSmoking : [],
        preferred_diet: Array.isArray(profileData.preferredDiet) ? profileData.preferredDiet : [],
        preferred_pets: Array.isArray(profileData.preferredPets) ? profileData.preferredPets : [],
        preferred_children: Array.isArray(profileData.preferredChildren) ? profileData.preferredChildren : [],
