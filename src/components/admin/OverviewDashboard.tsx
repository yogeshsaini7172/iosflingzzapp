...
const OverviewDashboard: React.FC<OverviewDashboardProps> = ({ metrics }) => {
  if (!metrics) {
    return (
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{metrics.pendingConsulting}</div>
            <p className="text-xs text-muted-foreground">
              Consulting requests
            </p>
          </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{metrics.publishedNews}</div>
            <p className="text-xs text-muted-foreground">
              News articles
            </p>
          </CardContent>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm">{metrics.pendingConsulting} pending requests</span>
            </div>
          </div>
        </CardContent>
      </Card>
